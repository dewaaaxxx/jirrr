...
static void DrawContentArea(float sidebarW, float winW, float winH) {
    ...
    switch (g_menu.currentTab) {
        ...
        case 3: {
            ...
            SameLine();
            TextColored(ImVec4(0.9f, 0.9f, 1.0f, 1.0f), O("@xabi666"));
            Dummy(ImVec2(0, 10));
            ...
            SameLine();
            TextColored(ImVec4(0.9f, 0.9f, 1.0f, 1.0f), O("8BP V.56.27.0"));
            break;
        }
    }
...
INLINE void DrawLogin(ImGuiIO& io) {
    ...
    ImVec2 titleSize = CalcTextSize("CM ENGINE");
    dl->AddText(ImVec2(winPos.x + (cardW - titleSize.x) * 0.5f, winPos.y + 30), IM_COL32(255, 255, 255, 255), "CM ENGINE");
    SetWindowFontScale(1.0f);
